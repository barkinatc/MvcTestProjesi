...
namespace TestProject.DataAccess.Concrete.EntityFrameworkCore
{
    public class TestProjectDbContext : DbContext
    {
        ...
        {
            // optionsBuilder.UseSqlServer(@"Data Source=.;Database=TestProject;integrated security=true;Connection Timeout=1800;MultipleActiveResultSets=True");
            optionsBuilder.UseSqlServer(@"Server = .; Database = TestProject; Trusted_Connection = True;");
        }
