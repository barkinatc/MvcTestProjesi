        ...
        public async Task<IActionResult> Register(RegisterViewModel registerViewModel)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var projectUrl = _configuraiton.GetSection("ProjectSettings").GetSection("ProjectUrl").Value;
                    ...
                    emailAddressesFrom.Add(new EmailAddress { Name = "Test Project Bilgilendirme", Address = _configuraiton.GetSection("EmailConfiguration").GetSection("EmailFrom").Value });
                    _mailService.Send(new EmailMessage { Context = callBackUrl, ToAddresses = emailAddressesTo, Subject = registerViewModel.UserName, FromAddresses = emailAddressesFrom });
